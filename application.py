...
def view():
    ...
    logging.info(str1)
    if str1 == "":
        L2.config(text="Please wait a little")
    else:
        str = "displaying files that are pinned to local node from website\n" + str1
        L2.config(text=str)
...
def view1():
    ...
    # logging.info(str1)
    # if str1 == "":
    #     L2.config(text="Wait a little")
    # else:
    # str = "displaying files that are pinned to local node" + str1
    L2.config(text=local_files)
